...
//======================//Home Page======================================================
	...
	String lifeQuote = "Life";
	private By selecteStates = By.id("sState");
	...
	public void SaveQuote() throws InterruptedException{
		homePage.saveGetQuote_selectOptionByText(driver.findElement(selectQuote), homeOwnersQuote , zipCode, email);
	}


	@Test
	public void life_Health_LongTermCareQuote(){
		homePage.Life_Health_Long_TermCare_Quote_selectOptionByText(driver.findElement(selectQuote),  lifeQuote, driver.findElement(selecteStates), selectedState);
	}
