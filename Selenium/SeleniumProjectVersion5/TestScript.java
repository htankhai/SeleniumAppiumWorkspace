...
public class TestScript extends projectFunction{
	...
	public static void loginToSFDC() throws IOException, InterruptedException{
		...
		/*Read data Parameter*/
		String recData[][] = null;
		String DataTablePath = "C:/Users/Selenium/Desktop/Feb11 Framework/DataFolder/GlobalDatasheet.xls";
		...
		clickObject("//*[@id='userNav-arrow']", "Close message box");
		clickObject("//*[@id='userNav-menuItems']/a[3]", "Close message box");
...
//		driver.switchTo().window(b);
	...
	public static void LoginErrorMessage() throws IOException, InterruptedException{
		...
		/*Read TestData*/
		DataTablePath = "C:/Users/shwetha/Desktop/Framework/TestData/LoginErrorMessage.xls";
		recData = projectFunction.readSheet(DataTablePath, "Sheet1");
...
//		}
	...
	public static void editMyProfile() throws IOException, InterruptedException{
		...
		/*Enter Last name*/
		enterText("//*[@id='lastName']", "New LastName", "Last Name");
