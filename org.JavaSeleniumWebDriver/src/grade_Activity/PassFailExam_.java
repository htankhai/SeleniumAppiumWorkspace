...
*/
public class PassFailExam_ extends PassFailActivity_
{
   ...
   /**
      The constructor sets the number of questions, the number of questions missed,
      and the minimum passing score.
      @param questions The number of questions.
      @param missed The number of questions missed.
      @param minPassing The minimum passing score.
   */
   public PassFailExam_(int questions, int missed, double minPassing)
   {
