...
import java.io.*;  
/**
   This program uses the TestScoreReader class to read test scores from a file and 
   get their averages.
*/
public class TestAverages{
   public static void main(String[] args) throws IOException
   {
      ...
      TestScoreReader scoreReader =
                  new TestScoreReader("C:/Users/htan/EclipseWorkspace/Starting out with Java/sourceCodeChapter10/Grades.csv");
